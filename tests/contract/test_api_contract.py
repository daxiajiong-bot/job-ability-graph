...
class V3ContractTest(unittest.TestCase):
    def setUp(self) -> None:
        ...
        # Use in-memory DB for tests to avoid SQLite file locking issues on Windows
    ...
    def tearDown(self) -> None:
        # Close SQLite connections if any before cleanup
    ...
    def test_ollama_mode_profiles_and_capabilities_are_available(self) -> None:
        with patch.dict("os.environ", {"LLM_BACKEND": "ollama", "DB_BACKEND": "memory"}, clear=False):
