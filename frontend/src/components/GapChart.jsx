      ...
      <Card title="技能差距详情" size="small">
        ...
        >
          <div style={{ textAlign: "center" }}>
            ...
            <div style={{ fontSize: 12, color: "#8b949e" }}>已掌握</div>
          </div>
          <div style={{ textAlign: "center" }}>
            <div style={{ fontSize: 24, fontWeight: 700, color: "#ff4d4f" }}>
              {missingSkills.length}
            </div>
            <div style={{ fontSize: 12, color: "#8b949e" }}>缺失</div>
          </div>
          <div style={{ textAlign: "center" }}>
            <div style={{ fontSize: 24, fontWeight: 700, color: "#faad14" }}>
              {partialSkills.length}
            </div>
            <div style={{ fontSize: 12, color: "#8b949e" }}>部分匹配</div>
          </div>
        </div>
          ...
          partialSkills.length === 0 && (
            <div>
              <Divider style={{ margin: "16px 0" }}>
                <span style={{ color: "#8b949e", fontSize: 12 }}>维度得分</span>
              </Divider>
              {Object.entries(dimScores).map(([name, value]) => (
                <div key={name} style={{ marginBottom: 12 }}>
                  ...
                  >
                    <Text style={{ color: "#8b949e", fontSize: 13 }}>{name}</Text>
                    <Text
                      style={{
