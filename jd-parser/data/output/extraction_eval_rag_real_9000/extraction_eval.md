...
| skill_coverage | 0.9778 | 至少抽到一个技能的岗位比例 |
| required_skill_doc_coverage | 0.885 | 有必需技能的岗位比例 |
| preferred_skill_doc_coverage | 0.4823 | 有优先技能的岗位比例 |
| education_coverage | 0.9871 | 有学历要求的岗位比例 |
| experience_coverage | 0.7674 | 有经验年限要求的岗位比例 |
| location_coverage | 1.0 | 有地点信息的岗位比例 |
| avg_skills_per_doc | 10.4869 | 平均每条岗位抽取技能数 |
...
| docs_with_low_skill_density_ratio | 0.0584 | 技能数小于等于 1 的岗位比例 |
