...
5. responsibilities 只填岗位职责/工作内容，requirements 只填任职资格/能力要求。
6. 薪资、工资、薪酬、福利（如五险一金、双休、奖金、补贴、餐补、交通补贴、带薪年假等）、工作时间、工作地点等信息不得填入 responsibilities 或 requirements，应放入 employment 或 company。""",
}
